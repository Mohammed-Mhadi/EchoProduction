...
export default function SubscriptionEdit() {
  ...
  const [formData, setFormData] = useState({
    ...
    subscription_plan_type: "", // Added plan type field
  });
    ...
    const fetchSubscription = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          subscription_plan_type: data.subscription_plan_type || "", // Initialize plan type
        });
      } catch (err: any) {
  ...
  const validate = () => {
    ...
    if (!formData.subscription_paid_amount.trim())
      errors.subscription_paid_amount = "Paid amount is required";
    if (!formData.subscription_plan_type.trim())
      errors.subscription_plan_type = "Plan type is required";
  ...
  const handleUpdate = async () => {
    ...
    try {
      const payload: any = {
        ...
        subscription_plan_type: formData.subscription_plan_type, // Include plan type
      };
        ...
        <>
          ...
          <div className="mb-4">
            ...
            <Input
              ...
              error={!!formErrors.subscription_plan_type}
            />
            {formErrors.subscription_plan_type && (
              <p className="text-red-500 text-sm mt-1">
                {formErrors.subscription_plan_type}
              </p>
            )}
