...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Echo Media - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Echo Media - React.js Tailwind CSS Admin Dashboard Template"
      />
